...
class UI:
    ...
    def display(self,player):
        self.show_bar(player.health, player.properties['health'], self.health_bar_rect, HEALTH_COLOR)
        self.show_bar(player.energy, player.properties['energy'], self.energy_bar_rect, ENERGY_COLOR)
